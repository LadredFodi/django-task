...
from promotions.services import (
    PromotionService, PromotionDealershipService, PromotionSupplierService
)
...
class TestPromotionDealershipModel:
    ...
    def test_promotion_dealership_str(self, promotion_dealership):
        expected = f"{promotion_dealership.promotion.name} → {promotion_dealership.dealership.name} ({promotion_dealership.discount_percent}%)"
...
class TestPromotionSupplierModel:
    ...
    def test_promotion_supplier_str(self, promotion_supplier):
        expected = f"{promotion_supplier.promotion.name} → {promotion_supplier.supplier.name} ({promotion_supplier.discount_percent}%)"
...
class TestPromotionService:
    ...
    def test_check_applicable_with_min_amount(self, promotion):
        ...
        result = PromotionService.check_applicable(
            promotion,
...
class TestPromotionDealershipService:
    ...
    def test_get_dealership_promotions_by_dealership(
        self, dealership, promotion_dealership
    ):
        result = PromotionDealershipService.get_dealership_promotions_by_dealership(
            dealership.id
        )
    ...
    def test_check_exists(self, promotion, dealership, promotion_dealership):
        result = PromotionDealershipService.check_exists(
            promotion.id,
            dealership.id
        )
    ...
    def test_update_dealership_promotion(self, promotion_dealership):
        ...
        updated = PromotionDealershipService.update_dealership_promotion(
            promotion_dealership, data
        )
    ...
    def test_apply_promotion(self, promotion_dealership, promotion):
        ...
        updated = PromotionDealershipService.apply_promotion(
            promotion_dealership, amount
        )
    ...
    def test_get_top_dealerships(self, promotion_dealership):
        for _ in range(5):
            PromotionDealershipService.apply_promotion(
                promotion_dealership,
                Decimal('25000.00')
            )
...
class TestPromotionSupplierService:
    ...
    def test_get_supplier_promotions_by_supplier(
        self, supplier, promotion_supplier
    ):
        result = PromotionSupplierService.get_supplier_promotions_by_supplier(
            supplier.id
        )
    ...
    def test_check_exists(self, promotion, supplier, promotion_supplier):
        result = PromotionSupplierService.check_exists(
            promotion.id,
            supplier.id
        )
    ...
    def test_apply_promotion(self, promotion_supplier, promotion):
        ...
        updated = PromotionSupplierService.apply_promotion(
            promotion_supplier, amount
        )
    ...
    def test_get_top_suppliers(self, promotion_supplier):
        for _ in range(3):
            PromotionSupplierService.apply_promotion(
                promotion_supplier,
                Decimal('50000.00')
            )
...
class TestPromotionDealershipAPI:
    ...
    def test_retrieve_promotion_dealership(
        self, admin_client, promotion_dealership
    ):
...
class TestPromotionSupplierAPI:
    ...
    def test_retrieve_promotion_supplier(
        self, admin_client, promotion_supplier
    ):
