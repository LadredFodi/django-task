...
from customers.models import Sale, Customer
from dealerships.tasks import dealership_purchase_cars, _process_dealership_purchases
...
class TestDealershipInventoryModel:
    ...
    def test_inventory_str(self, dealership_inventory):
        expected = f"{dealership_inventory.dealership.name} - {dealership_inventory.car_model} (x{dealership_inventory.quantity})"
...
class TestDealershipCeleryTasks:
    ...
    def test_process_dealership_purchases(self, mock_find_offer, dealership, car_model, supplier):
        ...
        DealershipPreference.objects.create(
            dealership=dealership,
            preferred_brands=[car_model.brand]
        )
    ...
    def test_purchase_with_promotion(
        self, dealership, supplier_car, promotion_supplier, car_model_factory
    ):
