...
class TestCustomerModel:
    ...
    def test_customer_one_to_one_with_user(self, regular_user, db):
        customer = Customer.objects.create(user=regular_user, balance=Decimal("10000.00"))
...
class TestCustomerService:
    ...
    def test_create_customer(self, regular_user, db):
        customer = CustomerService.create_customer(
            user=regular_user, phone="+9876543210", country="GB", city="London", balance=Decimal("20000.00")
        )
    ...
    def test_update_customer(self, customer):
        data = {"phone": "+1111111111", "city": "San Francisco"}
...
class TestCustomerAPI:
    ...
    def test_update_profile(self, authenticated_client, customer):
        ...
        data = {"phone": "+9999999999", "city": "Los Angeles"}
