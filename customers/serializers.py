...
class SaleSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if price and original_price and price > original_price:
            raise serializers.ValidationError("Sale price cannot be higher than the original price.")
        ...
        if price and original_price and discount_applied:
            ...
            if abs(float(price) - float(expected_price)) > 0.01:
                raise serializers.ValidationError("Price does not match the applied discount.")
