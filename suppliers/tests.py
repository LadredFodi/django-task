...
from suppliers.tasks import update_supplier_preferences, _update_dealership_supplier_preferences
...
class TestSupplierDiscountModel:
    ...
    def test_supplier_discount_str(self, supplier_discount):
        expected = f"{supplier_discount.supplier.name} → {supplier_discount.dealership.name}: {supplier_discount.discount_percent}%"
...
class TestSupplierDiscountService:
    ...
    def test_check_and_apply_discount_sufficient_purchases(
        self, supplier, dealership, supplier_discount, car_model
    ):  
        for i in range(supplier_discount.min_purchases):
        ...
        result = SupplierDiscountService.check_and_apply_discount(
            supplier.id,
            dealership.id
        )
    ...
    def test_check_and_apply_discount_insufficient_purchases(
        self, supplier, dealership, supplier_discount
    ):
        result = SupplierDiscountService.check_and_apply_discount(
            supplier.id,
            dealership.id
...
class TestSupplierCeleryTasks:
    ...
    def test_update_supplier_preferences_task(
        self, dealership, supplier_car, dealership_inventory
    ):
    ...
    def test_update_dealership_supplier_preferences(
        self, dealership, supplier_car, dealership_inventory
    ):
    ...
    def test_update_dealership_with_promotion(
        self, mock_calculate, dealership, supplier_car, dealership_inventory
    ):
...
class TestSupplierCarAPI:
    ...
    def test_filter_supplier_cars_by_supplier(
        self, authenticated_client, supplier, supplier_car
    ):
        url = reverse('suppliercar-list')
...
class TestSupplierDiscountAPI:
    ...
    def test_create_supplier_discount_as_admin(
        self, admin_client, supplier, dealership
    ):
        url = reverse('supplierdiscount-list')
        data = {
