...
schema_view = get_schema_view(
    openapi.Info(title="Dealership Management API", default_version="v1"),
    public=True,
...
urlpatterns = [
    ...
    path(
        "api/v1/auth/confirm-email-change/<str:token>/", ConfirmEmailChangeView.as_view(), name="confirm_email_change"
    ),
    path(
        "api/v1/auth/confirm-username-change/<str:token>/",
        ConfirmUsernameChangeView.as_view(),
        name="confirm_username_change",
    ),
    # API Endpoints
